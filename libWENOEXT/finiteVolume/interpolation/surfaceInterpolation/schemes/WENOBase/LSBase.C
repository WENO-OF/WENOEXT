...
void Foam::LSBase::extendStencils
(
	const fvMesh& mesh,
	const label cellI,
...
void Foam::LSBase::distributeStencils
(
	const fvMesh& mesh,
...
Foam::scalarRectangularMatrix Foam::LSBase::calcMatrix
(
	const fvMesh& mesh,
	const label cellI,
...
Foam::scalar Foam::LSBase::calcGeom
(
	const vector x_ij,													
	const scalar n,  													
	const scalar m,   													
...
)
{
	...
	Dir_ = mesh.time().path()/"constant"/"LSBase" + Foam::name(polOrder_);	
